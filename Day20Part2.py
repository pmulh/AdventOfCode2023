    ...
    while pulse_q:
        ...
        for target in targets:
            if target == 'rx' and pulse == 0:
                print(f"Sending single low pulse to rx after {button_presses} button presses")
                break
            # if target == 'hf' and pulse == 1:
            #     print(f"Sending high pulse to hf after {button_presses} button presses")
            # if target == 'pm' and pulse == 1:
            #     print(f"Sending high pulse to pm after {button_presses} button presses")
            # if target == 'mk' and pulse == 1:
            #     print(f"Sending high pulse to pm after {button_presses} button presses")
            # if target == 'pk' and pulse == 1:
            #     print(f"Sending high pulse to pm after {button_presses} button presses")
            ...
            # if con_module_states['vf']['hf'] == 1:
            #     print(f"hf memory == 1 after {button_presses} button presses") # Every 4013 button presses
            # if con_module_states['vf']['pm'] == 1:
            #     print(f"pm memory == 1 after {button_presses} button presses") # Every 3881 button presses
            # if con_module_states['vf']['mk'] == 1:
            #     print(f"mk memory == 1 after {button_presses} button presses") # Every 3889 button presses
            # if con_module_states['vf']['pk'] == 1:
            #     print(f"pk memory == 1 after {button_presses} button presses") # Every 4021 button presses
...
print(f"\nLow pulse sent to rx after {lcm(4013, 3881, 3889, 4021)} button presses")
